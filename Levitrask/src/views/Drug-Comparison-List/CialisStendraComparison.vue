<template>
  <div class="cialis-stendra-comparison-page">
    <PageHeader />
...
const cialisStendraSidebarData = ref({
  ...
  quickSummary: {
    formsStrengths: 'Cialis: Tabs (2.5-20mg). Stendra: Tabs (50-200mg)',
    reminders: [
      'Cialis lasts much longer (up to 36h).',
      'Stendra acts faster (as quick as 15min).',
      'Only Cialis offers a daily option & treats BPH.',
      'Discuss side effect differences with doctor.',
    ],
  },
  relatedResources: [
...
/* Style for highlighting key differences (optional) */
td strong {
